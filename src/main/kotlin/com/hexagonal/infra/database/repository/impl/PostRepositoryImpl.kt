...
import com.hexagonal.infra.database.model.PostDbModel
import com.hexagonal.infra.database.repository.interfaces.PostRepositoryInterface
...
class PostRepositoryAdapter(
    ...
    override fun savePost(post: PostCore): PostCore {
       val output = this.springData.save(PostDbModel(
